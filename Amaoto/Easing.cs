...
namespace Amaoto
{
    public class Easing
    {
        public int EaseIn(Counter counter, int startPoint, int endPoint, CalcType type)
        {
            StartPoint = startPoint;
            EndPoint = endPoint;
            Sa = EndPoint - StartPoint;
            TimeMs = (int)counter.End;
            Type = type;
        ...
        public int EaseOut(Counter counter, int startPoint, int endPoint, CalcType type)
        {
            StartPoint = startPoint;
            EndPoint = endPoint;
            Sa = EndPoint - StartPoint;
