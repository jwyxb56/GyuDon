    ...
    internal class CAct演奏DrumsMtaiko : CActivity
    {
      ...
      //      }
        ...
        public override int On進行描画()
        {
            if( base.b初めての進行描画 )
			{
                this.nフラッシュ制御タイマ = DxLibDLL.DX.GetNowCount();
                base.b初めての進行描画 = false;
            }
            
            long num = DxLibDLL.DX.GetNowCount();
            ...
            if(TJAPlayer3.Tx.Taiko_Background[0] != null )
                TJAPlayer3.Tx.Taiko_Background[0].t2D描画( 0, 184 );
            ...
            if ( TJAPlayer3.stage演奏ドラム画面.bDoublePlay )
            {
                ...
                if(TJAPlayer3.Tx.Taiko_Background[1] != null )
                    TJAPlayer3.Tx.Taiko_Background[1].t2D描画( 0, 360 );
            }
            
            if(TJAPlayer3.Tx.Taiko_Base != null )
            {
                TJAPlayer3.Tx.Taiko_Base.t2D描画( TJAPlayer3.Skin.Game_Taiko_X[0], TJAPlayer3.Skin.Game_Taiko_Y[0]);
                if( TJAPlayer3.stage演奏ドラム画面.bDoublePlay )
                    TJAPlayer3.Tx.Taiko_Base.t2D描画( TJAPlayer3.Skin.Game_Taiko_X[1], TJAPlayer3.Skin.Game_Taiko_Y[1]);
            }
            if( TJAPlayer3.Tx.Taiko_Don_Left != null && TJAPlayer3.Tx.Taiko_Don_Right != null && TJAPlayer3.Tx.Taiko_Ka_Left != null && TJAPlayer3.Tx.Taiko_Ka_Right != null )
            {
                ...
                TJAPlayer3.Tx.Taiko_Ka_Left.t2D描画( TJAPlayer3.Skin.Game_Taiko_X[0], TJAPlayer3.Skin.Game_Taiko_Y[0], new Rectangle( 0, 0, TJAPlayer3.Tx.Taiko_Ka_Right.szテクスチャサイズ.Width / 2, TJAPlayer3.Tx.Taiko_Ka_Right.szテクスチャサイズ.Height) );
                TJAPlayer3.Tx.Taiko_Ka_Right.t2D描画( TJAPlayer3.Skin.Game_Taiko_X[0] + TJAPlayer3.Tx.Taiko_Ka_Right.szテクスチャサイズ.Width / 2, TJAPlayer3.Skin.Game_Taiko_Y[0], new Rectangle(TJAPlayer3.Tx.Taiko_Ka_Right.szテクスチャサイズ.Width / 2, 0, TJAPlayer3.Tx.Taiko_Ka_Right.szテクスチャサイズ.Width / 2, TJAPlayer3.Tx.Taiko_Ka_Right.szテクスチャサイズ.Height) );
                TJAPlayer3.Tx.Taiko_Don_Left.t2D描画( TJAPlayer3.Skin.Game_Taiko_X[0], TJAPlayer3.Skin.Game_Taiko_Y[0], new Rectangle( 0, 0, TJAPlayer3.Tx.Taiko_Ka_Right.szテクスチャサイズ.Width / 2, TJAPlayer3.Tx.Taiko_Ka_Right.szテクスチャサイズ.Height) );
                TJAPlayer3.Tx.Taiko_Don_Right.t2D描画( TJAPlayer3.Skin.Game_Taiko_X[0] + TJAPlayer3.Tx.Taiko_Ka_Right.szテクスチャサイズ.Width / 2, TJAPlayer3.Skin.Game_Taiko_Y[0], new Rectangle(TJAPlayer3.Tx.Taiko_Ka_Right.szテクスチャサイズ.Width / 2, 0, TJAPlayer3.Tx.Taiko_Ka_Right.szテクスチャサイズ.Width / 2, TJAPlayer3.Tx.Taiko_Ka_Right.szテクスチャサイズ.Height));
            }
            ...
            if( TJAPlayer3.Tx.Taiko_Don_Left != null && TJAPlayer3.Tx.Taiko_Don_Right != null && TJAPlayer3.Tx.Taiko_Ka_Left != null && TJAPlayer3.Tx.Taiko_Ka_Right != null )
            {
                ...
                TJAPlayer3.Tx.Taiko_Ka_Left.t2D描画( TJAPlayer3.Skin.Game_Taiko_X[1], TJAPlayer3.Skin.Game_Taiko_Y[1], new Rectangle( 0, 0, TJAPlayer3.Tx.Taiko_Ka_Right.szテクスチャサイズ.Width / 2, TJAPlayer3.Tx.Taiko_Ka_Right.szテクスチャサイズ.Height) );
                TJAPlayer3.Tx.Taiko_Ka_Right.t2D描画( TJAPlayer3.Skin.Game_Taiko_X[1] + TJAPlayer3.Tx.Taiko_Ka_Right.szテクスチャサイズ.Width / 2, TJAPlayer3.Skin.Game_Taiko_Y[1], new Rectangle(TJAPlayer3.Tx.Taiko_Ka_Right.szテクスチャサイズ.Width / 2, 0, TJAPlayer3.Tx.Taiko_Ka_Right.szテクスチャサイズ.Width / 2, TJAPlayer3.Tx.Taiko_Ka_Right.szテクスチャサイズ.Height) );
                TJAPlayer3.Tx.Taiko_Don_Left.t2D描画( TJAPlayer3.Skin.Game_Taiko_X[1], TJAPlayer3.Skin.Game_Taiko_Y[1], new Rectangle( 0, 0, TJAPlayer3.Tx.Taiko_Ka_Right.szテクスチャサイズ.Width / 2, TJAPlayer3.Tx.Taiko_Ka_Right.szテクスチャサイズ.Height) );
                TJAPlayer3.Tx.Taiko_Don_Right.t2D描画( TJAPlayer3.Skin.Game_Taiko_X[1] + TJAPlayer3.Tx.Taiko_Ka_Right.szテクスチャサイズ.Width / 2, TJAPlayer3.Skin.Game_Taiko_Y[1], new Rectangle(TJAPlayer3.Tx.Taiko_Ka_Right.szテクスチャサイズ.Width / 2, 0, TJAPlayer3.Tx.Taiko_Ka_Right.szテクスチャサイズ.Width / 2, TJAPlayer3.Tx.Taiko_Ka_Right.szテクスチャサイズ.Height) );
            }
            ...
            for ( int i = 0; i < TJAPlayer3.ConfigIni.nPlayerCount; i++ )
            {
                ...
                if( ( this.ctレベルアップダウン[ i ].b進行中 && ( TJAPlayer3.Tx.Taiko_LevelUp != null && TJAPlayer3.Tx.Taiko_LevelDown != null ) ) && !TJAPlayer3.ConfigIni.bNoInfo )
                {
                    ...
                    TJAPlayer3.Tx.Taiko_LevelDown.vc拡大縮小倍率 = TJAPlayer3.Tx.Taiko_LevelUp.vc拡大縮小倍率 = new PointF(fScale, fScale);
                    if( this.After[ i ] - this.Before[ i ] >= 0 )
                    {
                        //レベルアップ
                        TJAPlayer3.Tx.Taiko_LevelUp.Opacity = nAlpha;
                        TJAPlayer3.Tx.Taiko_LevelUp.t2D描画(-329, fY[i]);
                    }
                    else
                    {
                        TJAPlayer3.Tx.Taiko_LevelDown.Opacity = nAlpha;
                        TJAPlayer3.Tx.Taiko_LevelDown.t2D描画(-329, fY[i]);
                    }
                }
            }
            ...
            for( int i = 0; i < TJAPlayer3.ConfigIni.nPlayerCount; i++ )
            {
                ...
                {
                    TJAPlayer3.Tx.Couse_Symbol[TJAPlayer3.stage選曲.n確定された曲の難易度].t2D描画(
            ...
            {
                TJAPlayer3.Tx.Taiko_NamePlate[0].t2D描画(TJAPlayer3.Skin.Game_Taiko_NamePlate_X[0], TJAPlayer3.Skin.Game_Taiko_NamePlate_Y[0]);
            }
            if(TJAPlayer3.stage演奏ドラム画面.bDoublePlay && TJAPlayer3.Tx.Taiko_NamePlate[1] != null)
            {
                TJAPlayer3.Tx.Taiko_NamePlate[1].t2D描画(TJAPlayer3.Skin.Game_Taiko_NamePlate_X[1], TJAPlayer3.Skin.Game_Taiko_NamePlate_Y[1]);
            }

            if (TJAPlayer3.Tx.Taiko_PlayerNumber[0] != null)
            {
                TJAPlayer3.Tx.Taiko_PlayerNumber[0].t2D描画(TJAPlayer3.Skin.Game_Taiko_PlayerNumber_X[0], TJAPlayer3.Skin.Game_Taiko_PlayerNumber_Y[0]);
            }
            if (TJAPlayer3.stage演奏ドラム画面.bDoublePlay && TJAPlayer3.Tx.Taiko_PlayerNumber[1] != null)
            {
                TJAPlayer3.Tx.Taiko_PlayerNumber[1].t2D描画(TJAPlayer3.Skin.Game_Taiko_PlayerNumber_X[1], TJAPlayer3.Skin.Game_Taiko_PlayerNumber_Y[1]);
            }

            //if (CDTXMania.Input管理.Keyboard.IsPushedKey((int)DxLibDLL.DX.KEY_INPUT_V))
            //{
            //    this.tMtaikoEvent( 0x11, 0, 1 );
            //}
            //if (CDTXMania.Input管理.Keyboard.IsPushedKey((int)DxLibDLL.DX.KEY_INPUT_N))
            //{
            //    this.tMtaikoEvent( 0x11, 1, 1 );
            //}
            //if (CDTXMania.Input管理.Keyboard.IsPushedKey((int)DxLibDLL.DX.KEY_INPUT_C))
            //{
            //    this.tMtaikoEvent( 0x12, 0, 1 );
            //}
            //if (CDTXMania.Input管理.Keyboard.IsPushedKey((int)DxLibDLL.DX.KEY_INPUT_M))
            //{
