...
namespace TJAPlayer3
{
    ...
    internal class CSkin : IDisposable
    {
        ...
        public class Cシステムサウンド : IDisposable
        {
            ...
            public int n長さ_現在のサウンド
            {
                get
                {
                    ...
                    return (int)DxLibDLL.DX.GetSoundTotalTime(sound.Handle);
                }
            }
            ...
            public void t読み込み()
            {
                ...
                for (int i = 0; i < 2; i++)     // 一旦Cloneを止めてASIO対応に専念
                {
                    try
                    {
                        this.rSound[i] = new CSound(CSkin.Path(this.strファイル名));
                    }
                    catch
                    {
                        this.rSound[i] = null;
        ...
        public void PrepareReloadSkin()
        {
            ...
            this.soundカーソル移動音 = new Cシステムサウンド(@"Sounds\Move.ogg", false, false, false, ESoundGroup.Voice);
            this.sound決定音 = new Cシステムサウンド(@"Sounds\Decide.ogg", false, false, false, ESoundGroup.Voice);
            this.sound変更音 = new Cシステムサウンド(@"Sounds\Change.ogg", false, false, false, ESoundGroup.Voice);
            this.sound取消音 = new Cシステムサウンド(@"Sounds\Cancel.ogg", false, false, true, ESoundGroup.Voice);
            this.sound歓声音 = new Cシステムサウンド(@"Sounds\Audience.ogg", false, false, true, ESoundGroup.Voice);
            ...
            this.soundBalloon = new Cシステムサウンド(@"Sounds\balloon.ogg", false, false, true, ESoundGroup.Voice);
        ...
        public int nResultPanelP2X = 0;
        public int nResultPanelP2Y = 0;
        ...
        public int nResultScoreP1X = 141;
        public int nResultScoreP1Y = 228;
        public int nResultGreatP1X = 875 - 390;
        public int nResultGreatP1Y = 189;
        public int nResultGreatP2X = 875 - 390;
        public int nResultGreatP2Y = 189;
        public int nResultGoodP1X = 875 - 390;
        public int nResultGoodP1Y = 231;
        public int nResultGoodP2X = 875;
        public int nResultGoodP2Y = 226;
        public int nResultBadP1X = 875 - 390;
        public int nResultBadP1Y = 273;
        public int nResultBadP2X = 875;
        public int nResultBadP2Y = 266;
        public int nResultComboP1X = 875 - 390;
        public int nResultComboP1Y = 315;
        public int nResultComboP2X = 875;
        public int nResultComboP2Y = 188;
        public int nResultRollP1X = 875 - 390;
        public int nResultRollP1Y = 357;
        public int nResultRollP2X = 875;
        public int nResultRollP2Y = 226;

        public int nResultGaugeBaseP1X = 35;
        public int nResultGaugeBaseP1Y = 143;
        ...
        public Color SongSelect_BackColor_JPOP = ColorTranslator.FromHtml("#255351");
        public Color SongSelect_BackColor_Anime = ColorTranslator.FromHtml("#a22069");
        public Color SongSelect_BackColor_VOCALOID = ColorTranslator.FromHtml("#5B6278");
        public Color SongSelect_BackColor_Children = ColorTranslator.FromHtml("#a33903");
        public Color SongSelect_BackColor_Variety = ColorTranslator.FromHtml("#366600");
        public Color SongSelect_BackColor_Classic = ColorTranslator.FromHtml("#77723d");
        public Color SongSelect_BackColor_GameMusic = ColorTranslator.FromHtml("#4f1e7b");
        public Color SongSelect_BackColor_Namco = ColorTranslator.FromHtml("#972804");
        ...
        public int Result_MusicName_Y = 21;
        public int Result_MusicName_FontSize = 30;
        public ReferencePoint Result_MusicName_ReferencePoint = CSkin.ReferencePoint.Center;
